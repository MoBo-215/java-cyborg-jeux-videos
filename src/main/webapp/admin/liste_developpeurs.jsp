                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Développeurs</a></li>
                                            <li class="breadcrumb-item active">Liste des développeurs</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Développeurs</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Liste des développeurs</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td><%=d.getNom() %></td>
                                            <td>
                                            	<a href="Modifier_developpeur?id=<%=d.getId()%>" class="btn btn-primary">Modifier</a>
                                            	<a href="Liste_developpeurs?del=<%=d.getId()%>" class="btn btn-danger">Supprimer</a>
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
