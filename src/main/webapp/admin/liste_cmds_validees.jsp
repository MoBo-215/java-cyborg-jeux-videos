                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Commandes validées</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	...
                                            	<a href="Liste_cmds_validees?exp=<%=c.getId() %>" class="btn btn-primary">Expédier</a>
                                            	<a href="Liste_cmds_validees?del=<%=c.getId() %>" class="btn btn-danger">Supprimer</a>
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
