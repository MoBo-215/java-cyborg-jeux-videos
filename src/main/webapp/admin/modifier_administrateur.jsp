                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-box">
                                    <h4 class="header-title">Modifier l'administrateur : <%= admin.getNom() %></h4>
                                    ...
                                    <form method="POST" action="#" class="parsley-examples">
                                        <div class="form-group mb-3">
                                            <input type="text" name="nom" required
                                                    value="<%= admin.getNom() %>" class="form-control" id="nom">
                                        </div>
                                        <div class="form-group mb-3">
                                            <input type="email" name="email" required
                                                    value="<%= admin.getEmail() %>" class="form-control" id="email">
                                        </div>
                                        <div class="form-group mb-3">
                                            <input type="password" name="password" required
                                                    value="<%= admin.getMot_de_passe() %>" class="form-control" id="password">
                                        </div>
