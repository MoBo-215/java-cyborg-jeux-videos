                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Commandes en attente</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td><%=c.getEtat() %></td>
                                            <td>
                                            	<a href="Details_commande_admin?id=<%=c.getId() %>" class="btn btn-warning">Details</a>
                                            	<a href="Liste_cmds_attente?valid=<%=c.getId() %>" class="btn btn-primary">Valider</a>
                                            	<a href="Liste_cmds_attente?del=<%=c.getId() %>" class="btn btn-danger">Supprimer</a>
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
