                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="assets/images/flags/french.jpg" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Français<i class="mdi mdi-chevron-down"></i> </span>
                        </a>
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <% if((String)session.getAttribute("isCo")=="yes"){ %>
                            <span class="pro-user-name ml-1">
                                ${adminnom} <i class="mdi mdi-chevron-down"></i>
                            </span>
                            <% } %>
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <!-- item-->
                            <a href="Deconnexion_admin" class="dropdown-item notify-item">
                ...
                <ul class="list-unstyled menu-left mb-0">
                    <li class="float-left">
                        <a href="index" class="logo">
                            ...
                            <span class="logo-sm">
                                <img src="assets/images/logo-c.png" alt="" height="30">
                            </span>
                        </a>
                    </li>
                    <li class="float-left">
