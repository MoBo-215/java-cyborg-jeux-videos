...
<%
	Categorie c = (Categorie)request.getAttribute("cat");
%>
<!DOCTYPE html>
<html lang="en">
    <!-- Head -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-box">
                                    <h4 class="header-title">Modifier la catégorie : <%=c.getNom() %></h4>
                                    ...
                                    <form method="POST" action="#" class="parsley-examples">
                                        <div class="form-group mb-3">
                                            <input type="text" name="nom" required
                                                    value="<%=c.getNom() %>" class="form-control" id="nom">
                                        </div>
                                        <div class="form-group mb-3">
                                            <input type="text" name="image_url" required
                                                    value="<%=c.getImage_url() %>" class="form-control" id="image_url">
                                        </div>
