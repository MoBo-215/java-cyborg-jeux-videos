                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Liste des langues</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td><%=l.getNom() %></td>
                                            <td>
                                            	<a href="Modifier_langue?id=<%=l.getId()%>" class="btn btn-primary">Modifier</a>
                                            	<a href="Liste_langues?del=<%=l.getId()%>" class="btn btn-danger">Supprimer</a>
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
