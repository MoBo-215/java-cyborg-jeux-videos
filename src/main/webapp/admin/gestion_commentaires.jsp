                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Commentaires</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Gestion des commentaires</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td><%=c.getNote() %></td>
                                            <td><%=c.getTexte() %></td>
                                            <td><%=udao.getById(c.getUtilisateur_id()).getNom() %></td>
                                            <td><%=jdao.getById(c.getJeu_id()).getTitre() %></td>
                                            <td><%=c.isApprouve() %></td>
                                            <td>
                                            	<% if(c.isApprouve()==false){ %>
                                  	            <a href="Gestion_commentaires?deban=<%=c.getId()%>" class="btn btn-success">Afficher</a>
                                            	<% } else{ %>
                                            	<a href="Gestion_commentaires?ban=<%=c.getId()%>" class="btn btn-warning">Masquer</a>
                                            	<% } %>
                                            	
                                            	<a href="Gestion_commentaires?del=<%=c.getId()%>" class="btn btn-danger">Supprimer</a>                                            	
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
