                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Langues</a></li>
                                            <li class="breadcrumb-item active">Modifier une langue</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Langues</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-box">
                                    <h4 class="header-title">Modifier la langue : <%=l.getNom() %></h4>
                                    ...
                                    <form method="POST" action="#" class="parsley-examples">
                                        <div class="form-group mb-3">
                                            <input type="text" name="nom" required
                                                    value="<%=l.getNom() %>" class="form-control" id="nom">
                                        </div>
