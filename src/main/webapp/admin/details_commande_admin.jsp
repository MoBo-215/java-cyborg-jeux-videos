                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Toutes les commandess</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Détails de la commande : <%=cmd.getId() %></h4>
                                    ...
                                    <table id="datatable" class="table table-bordered nowrap">
                                        ...
                                        <tr>
                                            <td><%=d.getId()%></td>
                                            <td><img src="<%=pdao.getById(d.getJeu_id()).getImage_un_url() %>" style="height:50px"></a></td>
	                    					<td><%=pdao.getById(d.getJeu_id()).getTitre() %></td>
	                    					<td><%=d.getNb() %></td>
	                    					<td><%=d.getPrixu() %>€</td>
	                    					<td><%=df.format(d.getPrixu() * d.getNb()) %>€</td>                    			
                                        </tr>
                                        <% } %>
                                        </tbody>
                                    </table>
