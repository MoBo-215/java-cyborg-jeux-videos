                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Commandes expédiées</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Commandes expédiées</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	...
                                            	<a href="Liste_cmds_expediees?del=<%=c.getId() %>" class="btn btn-danger">Supprimer</a>
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
