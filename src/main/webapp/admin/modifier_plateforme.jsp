                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Modifier une plateforme</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-box">
                                    <h4 class="header-title">Modifier la plateforme : <%=p.getNom() %></h4>
                                    ...
                                    <form method="POST" action="#" class="parsley-examples">
                                        <div class="form-group mb-3">
                                            <input type="text" name="nom" required
                                                    value="<%=p.getNom() %>" class="form-control" id="nom">
                                        </div>
