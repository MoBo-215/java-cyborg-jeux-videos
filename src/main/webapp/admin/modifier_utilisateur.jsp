                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-box">
                                    <h4 class="header-title">Modifier l'utilisateur : <%= user.getNom() %></h4>
                                    ...
                                    <form method="POST" action="#" class="parsley-examples">
                                        <div class="form-group mb-3">
                                            <input type="text" name="nom" required
                                                    value="<%= user.getNom() %>" class="form-control" id="nom">
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="password" name="password" required
                                                    value="<%= user.getMot_de_passe() %>" class="form-control" id="password">
                                        </div>
