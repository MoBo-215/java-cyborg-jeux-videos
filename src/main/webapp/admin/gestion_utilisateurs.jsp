                                ...
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td><%=u.getIsban() %></td>
                                            <td>
	                                            <a href="Liste_commandes_user?id=<%=u.getId()%>" class="btn btn-success">Commandes</a>
                                            	<a href="Modifier_utilisateur?id=<%=u.getId()%>" class="btn btn-primary">Modifier</a>
                                            	
                                            	<% if(u.getIsban()==true){ %>
                                  	            <a href="Gestion_utilisateurs?deban=<%=u.getId()%>" class="btn btn-success">Débannir</a>
                                            	<% } else{ %>
                                            	<a href="Gestion_utilisateurs?ban=<%=u.getId()%>" class="btn btn-warning">Bannir</a>
                                            	<% } %>
                                            	
                                            	<a href="Gestion_utilisateurs?del=<%=u.getId()%>" class="btn btn-danger">Supprimer</a>                                            	
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
