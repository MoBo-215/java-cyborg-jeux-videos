...
<%
	ArrayList<Administrateur> admins = (ArrayList)request.getAttribute("admins");
%>
<!DOCTYPE html>
<html lang="en">
    <!-- Head -->
                                ...
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-bordered nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td><%=u.getEmail() %></td>
                                            <td>
                                            	<a href="Modifier_administrateur?id=<%=u.getId() %>" class="btn btn-primary">Modifier</a>
                                            	<a href="Liste_administrateurs?del=<%=u.getId() %>" class="btn btn-danger">Supprimer</a>
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
