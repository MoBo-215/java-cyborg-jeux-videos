...
/**
 * Servlet implementation class LaLangue
 */
@WebServlet("/LaLangue")
public class LaLangue extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Jeu> jeux = new JeuDAO().getAllByLangue(l_id);
		...
		request.getRequestDispatcher("/lalangue.jsp").forward(request, response);
	}
